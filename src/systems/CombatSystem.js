...
export class CombatSystem {
  constructor(eventSystem, renderer) {
    ...
    this.eventSystem.on('createFrostImpact', this.createFrostImpactEffect.bind(this));
    this.eventSystem.on('createFireCritical', this.createFireCriticalEffect.bind(this));
    this.eventSystem.on('createBasicImpact', this.createBasicImpactEffect.bind(this));
    this.eventSystem.on('createFloatingDamage', this.createFloatingDamageNumber.bind(this));
  }
      ...
      update: (delta) => {
        ...
        shards.forEach(shard => {
          ...
          shard.position.copy(originalPos).add(
            dir.clone().multiplyScalar(elapsed * speed)
          );
